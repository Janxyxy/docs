...
<DescriptionImage src="/img/opsimg/dynamickebloky.png">
...
<DescriptionImage src="/img/opsimg/prekladAdres.jpg">
  Překlad adres
</DescriptionImage>
...
- Používá se v _servrových systémech_
...
- Správa sdílené paměti _určena dvěma principy_
...
## Dočasně sdílená paměť _Copy on Write_
